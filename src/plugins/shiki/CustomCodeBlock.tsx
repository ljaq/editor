              ...
              <Button
                ...
                icon={
                  editable ? (
                    ...
                    <img style={{ width: 18 }} src={(lanIcons as any)[language] || lanIcons.txt} />
                  )
                }
              ></Button>
            </Tooltip>
                ...
                {editable ? (
                  <Fragment>
                    <Select
                      ...
                      filterOption={(input, option: any) => option!.display.toLowerCase().includes(input.toLowerCase())}
                      options={languages.map((lan: any) => ({
                        display: lan || 'plain text',
                        label: (
                          <Row>
                            <img style={{ width: 18, marginRight: 8 }} src={(lanIcons as any)[lan] || lanIcons.txt} />
